 ...
 */
public class BrokenLinks extends Issue<CollectionResult<URL>> {
    ...
    @Override
    protected CollectionResult<URL> invoke() throws OpenRDFException {
        dereferenceURIs();
		return new CollectionResult<URL>(collectUnavailableURLs());
	}
