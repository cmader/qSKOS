...
public class InvolvedConceptsTest {
    ...
    {
        Collection<Resource> involvedConceptValues = involvedConceptsForConcepts.getResult();
    ...
    {
        Collection<Resource> involvedConceptValues = involvedConceptsForComponents.getResult();
