...
Parts of qSKOS' functionality have also been integrated into the {rsine}[https://github.com/rsine/rsine] (Resource Subscription and Notification Service) that enables you to monitor changes to, e.g., a SKOS vocabulary as they occur and send out immediate notifications if some potential quality problems occur. Rsine is also published as open source and hosted on GitHub ({here}[https://github.com/rsine/rsine]).
