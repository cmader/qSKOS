...
If you cannot or do not want to checkout the source code using {git}[http://git-scm.com/], you can get the packaged source as {zip file}[https://github.com/cmader/qSKOS/archive/master.zip].
